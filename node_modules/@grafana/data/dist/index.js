...
var intersect = require('fast_array_intersect');
...
var intervalToDuration__default = /*#__PURE__*/_interopDefaultLegacy(intervalToDuration);
...
var SupportedTransformationTypes = /* @__PURE__ */ ((SupportedTransformationTypes2) => {
  SupportedTransformationTypes2["Regex"] = "regex";
  SupportedTransformationTypes2["Logfmt"] = "logfmt";
  return SupportedTransformationTypes2;
...
const hasQueryImportSupport = (datasource) => {
  return datasource.importFromAbstractQueries !== void 0;
};
const hasQueryExportSupport = (datasource) => {
  return datasource.exportToAbstractQueries !== void 0;
};
...
const hasLogsVolumeSupport = (datasource) => {
  return datasource.getLogsVolumeDataProvider !== void 0;
};

var NavSection = /* @__PURE__ */ ((NavSection2) => {
  NavSection2["Core"] = "core";
  NavSection2["Plugin"] = "plugin";
  NavSection2["Config"] = "config";
  return NavSection2;
})(NavSection || {});
var NavMenuItemType = /* @__PURE__ */ ((NavMenuItemType2) => {
  NavMenuItemType2["Section"] = "section";
  NavMenuItemType2["Item"] = "item";
  return NavMenuItemType2;
})(NavMenuItemType || {});
...
const isSystemOverride = (override) => {
  return typeof (override == null ? void 0 : override.__systemRef) === "string";
};
...
class AppPlugin extends GrafanaPlugin {
  ...
  configureExtensionLink(extension) {
    this._extensionConfigs.push(__spreadProps$C(__spreadValues$K({}, extension), {
...
function updateDatasourcePluginOption(props, key, val) {
  ...
  props.onOptionsChange(__spreadProps$B(__spreadValues$J({}, config), {
    [key]: val
  }));
}
const updateDatasourcePluginJsonDataOption = (props, key, val) => {
  const config = props.options;
  props.onOptionsChange(__spreadProps$B(__spreadValues$J({}, config), {
    jsonData: __spreadProps$B(__spreadValues$J({}, config.jsonData), {
      [key]: val
    })
  }));
};
const updateDatasourcePluginSecureJsonDataOption = (props, key, val) => {
  const config = props.options;
  props.onOptionsChange(__spreadProps$B(__spreadValues$J({}, config), {
    secureJsonData: __spreadProps$B(__spreadValues$J({}, config.secureJsonData ? config.secureJsonData : {}), {
      [key]: val
    })
  }));
};
const updateDatasourcePluginResetOption = (props, key) => {
  ...
  props.onOptionsChange(__spreadProps$B(__spreadValues$J({}, config), {
    ...
    secureJsonFields: __spreadProps$B(__spreadValues$J({}, config.secureJsonFields), {
      [key]: false
    })
  }));
};
...
const getTimeZone = (options) => {
  var _a, _b;
  return (_b = (_a = options == null ? void 0 : options.timeZone) != null ? _a : defaultTimeZoneResolver()) != null ? _b : DefaultTimeZone;
};
...
const toTz = (dateInUtc, timeZone) => {
  ...
  if (zone && zone.name) {
    return moment__default$1["default"].utc(date).tz(zone.name);
  }
  switch (timeZone) {
    case "utc":
      return moment__default$1["default"].utc(date);
    default:
      return moment__default$1["default"].utc(date).local();
  }
};
...
const parseString = (value, options) => {
  ...
  if (value.indexOf("now") !== -1) {
    if (!isValid(value)) {
      return moment__default$1["default"]();
    }
    ...
    return parsed || moment__default$1["default"]();
  }
  const timeZone = getTimeZone(options);
  const zone = moment__default$1["default"].tz.zone(timeZone);
  const format = (_a = options == null ? void 0 : options.format) != null ? _a : systemDateFormats.fullDate;
  if (zone && zone.name) {
    return moment__default$1["default"].tz(value, format, zone.name);
  }
  switch (lodash.lowerCase(timeZone)) {
    case "utc":
      return moment__default$1["default"].utc(value, format);
    default:
      return moment__default$1["default"](value, format);
  }
};
const parseOthers = (value, options) => {
  ...
  const zone = moment__default$1["default"].tz.zone(timeZone);
  if (zone && zone.name) {
    return moment__default$1["default"].tz(date, zone.name);
  }
  switch (lodash.lowerCase(timeZone)) {
    case "utc":
      return moment__default$1["default"].utc(date);
    default:
      return moment__default$1["default"](date);
  }
};
...
function describeInterval(str) {
  ...
  if (!matches || !lodash.has(intervals_in_seconds, matches[2])) {
    throw new Error(
...
const mapInternal = (zone, timestamp) => {
  ...
  switch (zone) {
    ...
    case "" /* default */: {
      ...
      const info = (_a = isInternal ? mapInternal(tz, timestamp) : mapToInfo(tz, timestamp)) != null ? _a : {};
      return __spreadProps$A(__spreadValues$I({
        countries: (_b = countriesByTimeZone[tz]) != null ? _b : [],
        abbreviation: "",
        offsetInMins: 0
      }, info), {
    ...
    case "browser" /* localBrowserTime */: {
      ...
      const info = (_c = mapToInfo(tz, timestamp)) != null ? _c : {};
      return __spreadProps$A(__spreadValues$I({
        countries: (_d = countriesByTimeZone[tz]) != null ? _d : [],
...
function intervalToAbbreviatedDurationString(interval, includeSeconds = true) {
  ...
  const duration = intervalToDuration__default["default"](interval);
...
function parseDuration(durationString) {
  return durationString.split(" ").reduce((acc, value) => {
    ...
    return mapping ? __spreadProps$z(__spreadValues$H({}, acc), { [mapping[0]]: length }) : acc;
  }, {});
}
function addDurationToDate(date, duration) {
  return add__default["default"](date, duration);
}
...
function findCommonLabels(labelsSets) {
  return labelsSets.reduce(
    ...
    __spreadValues$G({}, labelsSets[0])
  );
}
function findUniqueLabels(labels, commonLabels) {
  const uncommonLabels = __spreadValues$G({}, labels);
...
class AsNumberVector extends FunctionalVector {
  constructor(field) {
    super();
    this.field = field;
  }
...
function dataFrameToJSON(frame) {
  ...
  const schema = {
    ...
    fields: frame.fields.map((f) => {
      const _a = f, { values, state, display } = _a, sfield = __objRest$3(_a, ["values", "state", "display"]);
...
function convertTableToDataFrame(table) {
  const fields = table.columns.map((c) => {
    const _a = c, { text, type } = _a, disp = __objRest$2(_a, ["text", "type"]);
    return {
...
const guessFieldTypes = (series, guessDefined = false) => {
  for (const field of series.fields) {
    if (!field.type || field.type === FieldType.other || guessDefined) {
      return __spreadProps$x(__spreadValues$E({}, series), {
        fields: series.fields.map((field2) => {
          if (field2.type && field2.type !== FieldType.other && !guessDefined) {
            return field2;
          }
          return __spreadProps$x(__spreadValues$E({}, field2), {
...
const toLegacyResponseData = (frame) => {
  ...
  return {
    columns: fields.map((f) => {
      const { name, config } = f;
      if (config) {
        const column = __objRest$2(config, []);
        column.text = name;
        return column;
      }
      return { text: name };
...
function sortDataFrame(data, sortIndex, reverse = false) {
  ...
  return __spreadProps$x(__spreadValues$E({}, data), {
    fields: data.fields.map((f) => {
      return __spreadProps$x(__spreadValues$E({}, f), {
...
function preProcessPanelData(data, lastResult) {
  ...
  if (data.state === LoadingState.Loading && series.length === 0) {
    ...
    return __spreadProps$x(__spreadValues$E({}, lastResult), {
...
class MutableDataFrame extends FunctionalVector {
  ...
  addField(f, startLength) {
    ...
    const field = __spreadProps$w(__spreadValues$D({}, f), {
      name,
      type,
      config: f.config || {},
...
class DataFrameView extends FunctionalVector {
  ...
  toArray() {
    return new Array(this.data.length).fill(0).map((_, i) => __spreadValues$C({}, this.get(i)));
  }
}
...
function reduceField(options) {
  ...
  if ((_a = field.state) == null ? void 0 : _a.calcs) {
    ...
    if (missing.length < 1) {
      return __spreadValues$B({}, field.state.calcs);
    }
  }
  if (!field.state) {
    field.state = {};
  ...
  if (data.length < 1) {
    const calcs = __spreadValues$B({}, field.state.calcs);
  ...
  if (queue.length === 1 && queue[0].reduce) {
    ...
    field.state.calcs = __spreadValues$B(__spreadValues$B({}, field.state.calcs), values2);
    return values2;
  }
  let values = doStandardCalcs(field, ignoreNulls, nullAsZero);
  for (const reducer of queue) {
    if (!values.hasOwnProperty(reducer.id) && reducer.reduce) {
      values = __spreadValues$B(__spreadValues$B({}, values), reducer.reduce(field, ignoreNulls, nullAsZero));
    }
  }
  field.state.calcs = __spreadValues$B(__spreadValues$B({}, field.state.calcs), values);
  return values;
}
...
const sanitizeTextPanelWhitelist = new xss__namespace.FilterXSS({
  whiteList: XSSWL,
  css: {
    whiteList: __spreadProps$v(__spreadValues$A({}, xss__namespace.getDefaultCSSWhiteList()), {
      "flex-direction": true,
      "flex-wrap": true,
      "flex-basis": true,
      "flex-grow": true,
...
function renderMarkdown(str, options) {
  if (!hasInitialized) {
    marked.marked.setOptions(__spreadValues$z({}, markdownOptions));
    hasInitialized = true;
  }
  let opts = void 0;
  if (options == null ? void 0 : options.breaks) {
    opts = __spreadProps$u(__spreadValues$z({}, markdownOptions), {
      breaks: true
    });
  }
...
class FieldCache {
  constructor(data) {
    ...
    this.fieldByName = {};
    this.fieldByType = {};
    this.fields = data.fields.map((field, idx) => __spreadProps$t(__spreadValues$y({}, field), {
      index: idx
    }));
    for (let i = 0; i < data.fields.length; i++) {
      const field = data.fields[i];
      ...
      this.fieldByType[field.type].push(__spreadProps$t(__spreadValues$y({}, field), {
        index: i
      }));
      if (this.fieldByName[field.name]) {
        console.warn("Duplicate field names in DataFrame: ", field.name);
      } else {
        this.fieldByName[field.name] = __spreadProps$t(__spreadValues$y({}, field), { index: i });
      }
    }
  }
  getFields(type) {
...
class CircularDataFrame extends MutableDataFrame {
  constructor(options) {
    super(void 0, (buffer) => {
      return new CircularVector(__spreadProps$s(__spreadValues$x({}, options), {
        buffer
      }));
    });
  }
...
function joinDataFrames(options) {
  ...
  if (options.frames.length === 1) {
    ...
    if (options.keepOriginIndices) {
      frameCopy = __spreadProps$r(__spreadValues$w({}, frame), {
        fields: frame.fields.map((f, fieldIndex) => {
          const copy = __spreadValues$w({}, f);
          const origin = {
            frameIndex: 0,
            fieldIndex
          };
  ...
  for (let frameIndex = 0; frameIndex < options.frames.length; frameIndex++) {
    ...
    for (let fieldIndex = 0; fieldIndex < frame.fields.length; fieldIndex++) {
      ...
      if (!join2 && joinFieldMatcher(field, frame, options.frames)) {
        ...
        if (frame.name) {
          labels = __spreadProps$r(__spreadValues$w({}, labels), { name: frame.name });
        }
        fields.push(__spreadProps$r(__spreadValues$w({}, field), {
          labels
  ...
  return {
    ...
    fields: originalFields.map((f, index) => __spreadProps$r(__spreadValues$w({}, f), {
...
function join(tables, nullModes, mode = JoinMode.outer) {
  ...
  if (mode === JoinMode.inner) {
    xVals = new Set(intersect__default["default"](tables.map((t) => t[0])));
  } else {
    ...
    return outerSource.pipe(
      ...
      operators.map((data) => {
        ...
        if (mode === "reduceRow" /* ReduceRow */) {
          ...
          const binaryOptions = __spreadProps$q(__spreadValues$v({}, options.binary), {
          ...
          return data.map((frame) => {
            ...
            return __spreadProps$q(__spreadValues$v({}, frame), {
...
function concatenateFields(data, opts) {
  ...
  if (!sameLength) {
    fields = fields.map((f) => {
      ...
      return __spreadProps$p(__spreadValues$u({}, f), {
        values: new ArrayVector(values)
      });
    });
  }
...
const convertFieldTypeTransformer = {
  ...
  defaultOptions: {
    fields: {},
    conversions: [{ targetField: void 0, destinationType: void 0, dateFormat: void 0 }]
  },
...
function convertFieldTypes(options, frames) {
  ...
  const framesCopy = frames.map((frame) => __spreadValues$t({}, frame));
...
function fieldToTimeField(field, dateFormat) {
  ...
  return __spreadProps$o(__spreadValues$t({}, field), {
    type: FieldType.time,
...
function fieldToStringField(field, dateFormat) {
...
function fieldToEnumField(field, cfg) {
  const enumConfig = __spreadValues$t({}, cfg);
  ...
  return __spreadProps$o(__spreadValues$t({}, field), {
    config: __spreadProps$o(__spreadValues$t({}, field.config), {
      type: {
        enum: enumConfig
      }
    }),
    ...
    return source.pipe(
      operators.map((data) => {
        ...
        for (const series of data) {
          ...
          const copy = __spreadProps$n(__spreadValues$s({}, series), {
      ...
      operators.map((data) => {
        ...
        for (const frame of data) {
          ...
          for (const field of frame.fields) {
            ...
            fields.push(__spreadProps$m(__spreadValues$r({}, field), {
              values: new ArrayVector(buffer),
              state: {}
            }));
          }
          processed.push(__spreadProps$m(__spreadValues$r({}, frame), {
            fields,
            length: frameLength
          }));
        }
          ...
          for (let field of frame.fields) {
            ...
            if (!valuesByField[fieldName]) {
              valuesByField[fieldName] = {
                name: fieldName,
                type: field.type,
                config: __spreadValues$q({}, field.config),
                values: new ArrayVector()
              };
            }
...
function createColors(colors) {
  ...
  const getRichColor = ({ color, name }) => {
    color = __spreadProps$l(__spreadValues$p({}, color), { name });
    if (!color.main) {
  ...
  return lodash.merge(
    __spreadProps$l(__spreadValues$p({}, base), {
...
function createTypography(colors, typographyInput = {}) {
  ...
  const buildVariant = (fontWeight, size2, lineHeight, letterSpacing, casing) => {
    ...
    return __spreadValues$o(__spreadValues$o({
      fontFamily,
      fontWeight,
...
function createV1Theme(theme) {
  ...
  const basicColors = __spreadProps$k(__spreadValues$n({}, commonColorsPalette), {
    black: "#000000",
    white: "#ffffff",
    dark1: "#141414",
    dark2: "#161719",
  ...
  return __spreadProps$k(__spreadValues$n({}, oldCommon), {
    type: theme.colors.mode === "dark" ? GrafanaThemeType.Dark : GrafanaThemeType.Light,
    isDark: theme.isDark,
    isLight: theme.isLight,
    name: theme.name,
    palette: __spreadProps$k(__spreadValues$n({}, basicColors), {
    ...
    colors: __spreadProps$k(__spreadValues$n(__spreadValues$n(__spreadValues$n(__spreadValues$n({}, backgrounds), borders), form), textColors), {
...
function createTheme(options = {}) {
  ...
  const theme = {
    ...
    transitions,
    visualization,
    zIndex: __spreadValues$m({}, zIndex),
    flags: {}
  };
  return __spreadProps$j(__spreadValues$m({}, theme), {
...
function getHistogramFields(frame) {
  ...
  if (!xMax && xMin && xMin.values.length > 1) {
    ...
    xMax = __spreadProps$i(__spreadValues$l({}, xMin), {
  ...
  if (!xMin && xMax && (xMax == null ? void 0 : xMax.values.length) > 1) {
    ...
    let bucketSize = roundDecimals(vals[1] - vals[0], 6);
    xMin = __spreadProps$i(__spreadValues$l({}, xMax), {
...
function buildHistogram(frames, options) {
  ...
  let bucketOffset = (_a = options == null ? void 0 : options.bucketOffset) != null ? _a : 0;
  ...
  let bucketDecimals = ((_b = ("" + bucketSize).match(/\.\d+$/)) != null ? _b : ["."])[0].length - 1;
  let histograms = [];
  let counts = [];
  let config = void 0;
  for (const frame of frames) {
    for (const field of frame.fields) {
      if (field.type === FieldType.number) {
        ...
        counts.push(__spreadProps$i(__spreadValues$l({}, field), {
          config: __spreadProps$i(__spreadValues$l({}, field.config), {
  ...
  const xMin = {
    ...
    type: FieldType.number,
    state: void 0,
    config: bucketDecimals === 0 ? config != null ? config : {} : __spreadProps$i(__spreadValues$l({}, config), {
      decimals: bucketDecimals
    })
  };
  const xMax = __spreadProps$i(__spreadValues$l({}, xMin), {
    name: histogramFrameBucketMaxFieldName,
  ...
  if (options == null ? void 0 : options.combine) {
    ...
    counts = [
      __spreadProps$i(__spreadValues$l({}, counts[0]), {
        name: "count",
  ...
  transformer: (options) => (data) => {
    ...
    for (const frame of data) {
      ...
      for (const field of frame.fields) {
        ...
        const sansLabels = __spreadProps$h(__spreadValues$k({}, field), {
      ...
      result.push(__spreadProps$h(__spreadValues$k({}, frame), {
        fields: newFields,
        length: frame.length
      }));
    }
    ...
    operators.map((data) => {
      ...
      return data.map((frame) => {
        if (frame.length > limitFieldMatch) {
          return __spreadProps$g(__spreadValues$j({}, frame), {
            fields: frame.fields.map((f) => {
              const vals = f.values.toArray();
              return __spreadProps$g(__spreadValues$j({}, f), {
      ...
      for (let frameIndex = 0; frameIndex < data.length; frameIndex++) {
        ...
        for (let valueIndex = 0; valueIndex < frame.length; valueIndex++) {
          ...
          valuesByKey[key] = valuesByKey[key].map((existing) => {
            ...
            valueWasMerged = true;
            return __spreadValues$i(__spreadValues$i({}, existing), value);
          });
          if (!valueWasMerged) {
...
const copyFieldStructure$1 = (field) => {
  return __spreadProps$f(__spreadValues$i({}, lodash.omit(field, ["values", "state", "labels", "config"])), {
    values: new ArrayVector(),
    config: __spreadValues$i({}, lodash.omit(field.config, "displayName"))
  });
};
...
const orderFieldsTransformer = {
  ...
  operator: (options) => (source) => source.pipe(
    operators.map((data) => {
      ...
      return data.map((frame) => __spreadProps$e(__spreadValues$h({}, frame), {
...
const createRenamer = (renameByName) => (frame) => {
  ...
  return frame.fields.map((field) => {
    ...
    return __spreadProps$d(__spreadValues$g({}, field), {
      config: __spreadProps$d(__spreadValues$g({}, field.config), {
        displayName: renameTo
      }),
      state: __spreadProps$d(__spreadValues$g({}, field.state), {
        displayName: renameTo
      })
    });
  });
...
function reduceSeriesToRows(data, matcher, reducerId, labelsToFields) {
  ...
  for (const series of data) {
    ...
    processed.push(__spreadProps$c(__spreadValues$f({}, series), {
    ...
    for (const field of series.fields) {
      if (matcher(field, series, data)) {
        ...
        for (const reducer of reducers) {
          ...
          const copy = __spreadProps$c(__spreadValues$f({}, field), {
...
const renameFieldsByRegex = (options) => (frame) => {
  ...
  const fields = frame.fields.map((field) => {
    ...
    return __spreadProps$b(__spreadValues$e({}, field), {
      config: __spreadProps$b(__spreadValues$e({}, field.config), { displayName: newDisplayName }),
      state: __spreadProps$b(__spreadValues$e({}, field.state), { displayName: newDisplayName })
    });
  });
  return __spreadProps$b(__spreadValues$e({}, frame), { fields });
};
...
const copyFieldStructure = (field, name) => {
  return __spreadProps$a(__spreadValues$d({}, lodash.omit(field, ["values", "state", "labels", "config", "name"])), {
    name,
    values: new ArrayVector(),
    config: __spreadValues$d({}, lodash.omit(field.config, ["displayName", "displayNameFromDS"]))
  });
};
...
function attachFieldIndex(frame, sort) {
  return sort.map((s) => {
    ...
    return __spreadProps$9(__spreadValues$c({}, s), {
...
const getOperator = (config, ctx) => (source) => {
  ...
  const options = __spreadValues$b(__spreadValues$b({}, defaultOptions), config.options);
    ...
    switch (vm.type) {
      ...
      case MappingType.RegexToText:
        ...
        if (value.match(regex)) {
          const res = __spreadValues$a({}, vm.options.result);
          if (res.text != null) {
    ...
    for (let i = 0; i < panel.valueMaps.length; i++) {
      ...
      mappings.push(
        upgradeOldAngularValueMapping(
          __spreadProps$8(__spreadValues$a({}, map), {
            id: i,
            // used for order
...
const fallBackTreshold = { value: 0, color: FALLBACK_COLOR };
    ...
    },
    {
      ...
      getCalculator: (_field, theme) => {
        return (_value, _percent, threshold) => {
          const thresholdSafe = threshold != null ? threshold : fallBackTreshold;
...
function getFieldConfigWithMinMax(field, local) {
  ...
  if (local || !((_a = field.state) == null ? void 0 : _a.range)) {
    return __spreadValues$9(__spreadValues$9({}, config), getMinMaxAndDelta(field));
  }
  return __spreadValues$9(__spreadValues$9({}, config), field.state.range);
}
...
function getDisplayProcessor(options) {
  ...
  if (field.type === FieldType.time && !hasDateUnit) {
    ...
    return getEnumDisplayProcessor(options.theme, (_b = config.type) == null ? void 0 : _b.enum);
  }
...
function getEnumDisplayProcessor(theme, cfg) {
  var _a, _b;
  const config = {
    text: (_a = cfg == null ? void 0 : cfg.text) != null ? _a : [],
    color: (_b = cfg == null ? void 0 : cfg.color) != null ? _b : []
  };
  ...
  for (let s = 0; s < data.length && !hitLimit; s++) {
    ...
    for (let i = 0; i < dataFrame.fields.length && !hitLimit; i++) {
      ...
      if ((_b = field.state) == null ? void 0 : _b.range) {
        config = __spreadValues$8(__spreadValues$8({}, config), (_c = field.state) == null ? void 0 : _c.range);
      }
      const displayName = (_d = field.config.displayName) != null ? _d : "";
      ...
      if (reduceOptions.values) {
        ...
        for (let j = 0; j < field.values.length; j++) {
          ...
          values.push({
            name: "",
            field: config,
            display: __spreadProps$7(__spreadValues$8({}, displayValue), {
              title: rowName,
        ...
        for (const calc of calcs) {
          ...
          if (displayName !== "") {
            displayValue.title = replaceVariables(displayName, __spreadValues$8(__spreadValues$8({}, (_f = field.state) == null ? void 0 : _f.scopedVars), scopedVars));
          } else {
...
function getSmartDisplayNameForRow(frame, field, rowIndex, replaceVariables, scopedVars) {
  ...
  if (field.config.displayName) {
    return replaceVariables(field.config.displayName, __spreadValues$8(__spreadValues$8({}, (_a = field.state) == null ? void 0 : _a.scopedVars), scopedVars));
  }
  for (const otherField of frame.fields) {
    ...
    if (otherField.type === FieldType.string) {
      const value = (_b = otherField.values.get(rowIndex)) != null ? _b : "";
...
function setIndexForPaletteColor(field, currentLength) {
  return __spreadProps$7(__spreadValues$8({}, field.state), {
...
function createNoValuesFieldDisplay(options) {
  ...
  return {
    name: displayName,
    field: __spreadProps$7(__spreadValues$8({}, defaults), {
...
const identityOverrideProcessor = (value, _context, _settings) => {
  return value;
};
    ...
    // This object shows up in test snapshots
    {
      get: (obj, key) => {
        ...
        if (key === "labels" || key === "formattedLabels") {
          ...
          return __spreadProps$6(__spreadValues$7({}, field.labels), {
...
function applyFieldOverrides(options) {
  ...
  return options.data.map((originalFrame, index) => {
    var _a2, _b;
    const newFrame = __spreadValues$6({}, originalFrame);
    newFrame.fields = newFrame.fields.map((field) => {
      return __spreadProps$5(__spreadValues$6({}, field), {
        config: lodash.cloneDeep(field.config),
        state: __spreadValues$6({}, field.state)
      });
    });
    const scopedVars = {
    ...
    for (const field of newFrame.fields) {
      ...
      field.state.scopedVars = __spreadProps$5(__spreadValues$6({}, scopedVars), {
        __field: {
          text: "Field",
      ...
      let range = void 0;
      if (field.type === FieldType.number) {
        if (!globalRange && (!lodash.isNumber(config.min) || !lodash.isNumber(config.max))) {
...
const getLinksSupplier = (frame, field, fieldScopedVars, replaceVariables, timeZone) => (config) => {
  ...
  return field.config.links.map((link) => {
    ...
    const variables = __spreadProps$5(__spreadValues$6(__spreadValues$6({}, fieldScopedVars), dataFrameVars), {
    ...
    if (href) {
      ...
      href = replaceVariables(href, variables, schema.VariableFormatID.PercentEncode);
...
function applyRawFieldOverrides(data) {
  ...
  for (let frameIndex = 0; frameIndex < newData.length; frameIndex++) {
    const newFrame = __spreadValues$6({}, newData[frameIndex]);
    const newFields = [...newFrame.fields];
    for (let fieldIndex = 0; fieldIndex < newFields.length; fieldIndex++) {
      newFields[fieldIndex] = __spreadProps$5(__spreadValues$6({}, newFields[fieldIndex]), {
        display: processor
      });
    }
    newData[frameIndex] = __spreadProps$5(__spreadValues$6({}, newFrame), {
      fields: newFields
    });
  }
  return newData;
...
function addLogLevelToSeries(series, lineIndex) {
  ...
  return __spreadProps$3(__spreadValues$4({}, series), {
...
const LogsParsers = {
  ...
  logfmt: {
    buildMatcher: (label) => new RegExp(`(?:^|\\s)${lodash.escapeRegExp(label)}=("[^"]*"|\\S+)`),
    getFields: (line) => {
      const fields = [];
...
function calculateFieldStats(rows, extractor) {
  ...
  const countsByValue = lodash.countBy(rowsWithField, (r) => {
    const row = r;
...
function calculateLogsLabelStats(rows, label) {
  ...
  const countsByValue = lodash.countBy(rowsWithLabel, (row) => row.labels[label]);
  return getSortedCounts(countsByValue, rowCount);
}
function calculateStats(values) {
  const nonEmptyValues = values.filter((value) => value !== void 0 && value !== null);
  const countsByValue = lodash.countBy(nonEmptyValues);
  return getSortedCounts(countsByValue, nonEmptyValues.length);
}
const getSortedCounts = (countsByValue, rowCount) => {
  return lodash.chain(countsByValue).map((count, value) => ({ count, value, proportion: count / rowCount })).sortBy("count").reverse().value();
};
...
const sortLogsResult = (logsResult, sortOrder) => {
  ...
  return logsResult ? __spreadProps$3(__spreadValues$4({}, logsResult), { rows }) : { hasUniqueLabels: false, rows };
};
const sortLogRows = (logRows, sortOrder) => sortOrder === schema.LogsSortOrder.Ascending ? logRows.sort(sortInAscendingOrder) : logRows.sort(sortInDescendingOrder);
...
class FieldConfigEditorBuilder extends OptionsUIRegistryBuilder {
  addNumberInput(config) {
    var _a;
    return this.addCustomEditor(__spreadProps$2(__spreadValues$3({}, config), {
      id: config.path,
...
class ScopedEventBus {
  ...
  getStream(eventType) {
    return this.eventBus.getStream(eventType).pipe(operators.filter(this.filter));
  }
  // syntax sugar
  subscribe(typeFilter, handler) {
    return this.getStream(typeFilter).subscribe({ next: handler });
...
function createFieldConfigRegistry(config = {}, pluginName) {
  ...
  for (let fieldConfigProp of standardConfigs) {
    ...
    if (config.standardOptions) {
      const customDefault = (_b = config.standardOptions[fieldConfigProp.id]) == null ? void 0 : _b.defaultValue;
      const customSettings = (_c = config.standardOptions[fieldConfigProp.id]) == null ? void 0 : _c.settings;
      if (customDefault) {
        fieldConfigProp = __spreadProps$1(__spreadValues$2({}, fieldConfigProp), {
          defaultValue: customDefault
        });
      }
      if (customSettings) {
        fieldConfigProp = __spreadProps$1(__spreadValues$2({}, fieldConfigProp), {
          settings: fieldConfigProp.settings ? __spreadValues$2(__spreadValues$2({}, fieldConfigProp.settings), customSettings) : customSettings
        });
      }
    }
...
class PanelPlugin extends GrafanaPlugin {
  ...
  get fieldConfigDefaults() {
    ...
    return {
      defaults: __spreadValues$1({}, configDefaults),
  ...
  setDataSupport(support) {
    this.dataSupport = __spreadValues$1(__spreadValues$1({}, this.dataSupport), support);
    return this;
  }
  /**
...
function getPanelOptionsWithDefaults({
  ...
  const optionsWithDefaults = lodash.mergeWith(
    {},
    plugin.defaults,
    currentOptions || {},
    (objValue, srcValue) => {
...
exports.AsNumberVector = AsNumberVector;
...
exports.NavMenuItemType = NavMenuItemType;
...
exports.SupportedTransformationTypes = SupportedTransformationTypes;
...
exports.escapeUnescapedString = escapeUnescapedString;
...
exports.getEnumDisplayProcessor = getEnumDisplayProcessor;
...
exports.getLogsVolumeAbsoluteRange = getLogsVolumeAbsoluteRange;
exports.getLogsVolumeDataSourceInfo = getLogsVolumeDataSourceInfo;
...
exports.hasLogsVolumeSupport = hasLogsVolumeSupport;
...
exports.isLogsVolumeLimited = isLogsVolumeLimited;
